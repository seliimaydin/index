...
<div class="jumbotron d-flex align-items-center">
  ...
  <br><br>
    <h1 class="borderkanki display-1 mb-4">
        <img src="img/selimaydintop.png" width="70%" weight="70%" alt="">
        <br>
        <a target="_blank" href="https://www.linkedin.com/in/selimaydinn/" class="p-4 selim linkedincss fab fa-linkedin"></a>
        <a target="_blank" href="https://www.instagram.com/selimaydinresmi/" class="p-4 selim instagramcss fab fa-instagram"></a>
        <a target="_blank" href="https://www.youtube.com/@selimaydinn" class="p-4 selim youtubecss fab fa-youtube"></a>
        <a target="_blank" href="https://medium.com/@selimaydinn" class="p-4 selim mediumcss fab fa-medium"></a>
    </h1>
  </div>
    ...
    <div class="container">
        <div class="section-content">
            ...
            <div class="title-wrap mb-5" data-aos="fade-up">
                ...
                Hello, I am Selim Aydın ☕️ 🚀
                </h2>
                <p class="section-sub-title">Software Developer | Team Leader | Desinger</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12 text-center mt-4">
                            <div class="shadow rounded feature-item p-4 mb-4" data-aos="fade-up">
                                ...
                                <h4>Founder of Nebula Technology</h4>
                                <p>Founded for university-level technology competitions and entrepreneurship programs to participate.</p>
                            </div>
                            <div class="shadow rounded feature-item p-4 mb-4" data-aos="fade-up">
                                <div class="my-4">
                                    <i class="lnr lnr-frame-contract fs-40"></i>
                                </div>
                                <h4>T3 Fountation "Entrepreneur Training Program"</h4>
                                <p>I am one of the 250 people selected for the Entrepreneur Training Program.</p>
                            </div>
                        </div>
                        <!-- End of Feature Item -->
                        <!-- Features Item -->
                        <div class="col-md-4 col-sm-12 text-center">
                            <div class="shadow rounded feature-item p-4 mb-4" data-aos="fade-up">
                                ...
                                <h4>TEKNOFEST Experiences</h4>
                                <p>Final with 8 projects in total in 2020, 2021, 2022 and 2023. And 2 "Best Presentation" awards.</p>
                            </div>
                            <div class="shadow rounded feature-item p-4 mb-4" data-aos="fade-up">
                                <div class="my-4">
                                    <i class="lnr lnr-magic-wand fs-40"></i>
                                </div>
                                <h4>TUBITAK Experiences</h4>
                                <p>Final and semi-finals in competitions.</p>
                            </div>
                        </div>
                        <!-- End of Feature Item -->
                        <!-- Features Item -->
                        <div class="col-md-4 col-sm-12 text-center mt-4">
                            <div class="shadow rounded feature-item p-4 mb-4" data-aos="fade-up">
                                ...
                                <h4>Co-Founder of DEPUS</h4>
                                <p>This startup founded by 3 university students.</p>
                            </div>
                            <div class="shadow rounded feature-item p-4 mb-4" data-aos="fade-up">
                                <div class="my-4">
                                ...
                                <p>I am studying  Electrical-Electronic Engineering at Sakarya University of Applied Sciences.</p>
                            </div>
                        </div>
                        <!-- End of Feature Item -->
                    </div>
                ...
                <div class="col-md-12">
                    <div class="row align-items-center text-white">
                        ...
                        <div class="col-md-4 offset-md-2 col-sm-6" data-aos="fade-right">
                            <h4 class="mb-4">AYITO | Food Selection System</h4>
                            <p>AYİTO, reduces food waste in places where mass meals are made to zero. The cafeteria owner provides <b> financial profit </b> to the institution or company. It is a startup consisting of a food selection website.</p>
                            <a href="ayito" target="_blank">
                                 <button type="button" class="btn btn-outline-primary"> Go to Website </button>
                            </a>
                        </div><!--/ .col-md-4.col-md-offset-2.col-sm-6 -->

                        <div class="col-md-4 offset-md-right-2 col-sm-6" data-aos="flip-right">
                            <img class="my-5" src="img/ayitoapp.png" alt="">
                ...
                <div class="col-md-12">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 offset-md-2 col-sm-6" data-aos="flip-left">
                            <img class="my-5" src="img/kulturselapp.png" alt="">
                        </div><!--/ .col-md-4.col-md-offset-right-2.col-sm-6 -->

                        <div class="col-md-4 offset-md-right-2 col-sm-6" data-aos="fade-left">
                            <h4 class="mb-4">KültürSel (HL032) | Transferring Our Cultural Values to Future Generations</h4>
                            <p>Making a comprehensive mobile game using gamification method for To pass on our cultural values that are about to disappear to future generations and to increase and promote our country's tourism.</p>
                            
                            <a href="https://linktr.ee/selimaydin" target="_blank">
                                 <button type="button" class="btn btn-primary btn-shadow btn-lg"> Download </button>
                            </a>
            ...
            <div class="row ">
                <div class="col-md-12">
                    ...
                    <div class="title-wrap mb-5">
                        <h2>Teams or institutions that <span> work</span> with me</h2>
                    </div>
                ...
                <div class="col-md-12 client-holder">
                    <div class="client-slider owl-carousel">
                        ...
                        <div class="client-item">
                            <img class="img-responsive" src="img/client2.jpg" alt=" ">
                        </div>
                        <div class="client-item">
...
<div class="section-content pt-0">
            ...
            <div class="col-md-3" data-aos="fade-up">
                ...
                <div class="col-md-3" data-aos="fade-up" data-aos-delay="600">
                    ...
                    <h5>EMAIL</h5>
                    <strong><p><a href="mailto:selimaydinresmi@gmail.com">selimaydinresmi@gmail.com</a></p></strong>
                </div>
                <div class="col-md-3" data-aos="fade-up">
                    <span></span>
                    <h5></h5>
...
<section id="cta" class="bg-fixed overlay" style="background-image: url(img/bg.jpg);">
    <div class="container">
        <div class="section-content" data-aos="fade-up">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="mb-2">My CV</h2>
                    <p>Check out my CV</p>
                    <a href="https://drive.google.com/file/d/15W6OQJJYf3QiTWPJfwzDYsRmKaivILH_/view?usp=share_link" target="_blank" class="btn btn-outline-primary btn-lg">Click</a>
                </div>
            </div>
        </div>
    </div>
